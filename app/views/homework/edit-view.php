        ...
        <main id="main">
            <div class="page-content project-create project-edit fx-fullCenter">
                <div class="box mg-2 wt-50">
                    ...
                    <form action="<?php echo "/corvus/homeworks/update/{$data['id']}" ?>" method="post">
                        <div class="form-content">
                            ...
                            <label>
                                <fieldset class="field-input-container">
                                    <legend>Plazo: </legend>
                                    <input type="date" name="date_end" id="" pattern="[a-zA-Z0-9ñÑ_+-/].{1,}" value="<?php echo $data['date_term'] ?>">
                                </fieldset>
                            </label>
                            <label>
                                <fieldset class="field-input-container">
                        ...
                        <div class="buttons-container">
                            ...
                            <button type="submit" formaction="<?php echo "/corvus/homeworks/delete/{$data['id']}" ?>" class="btn btn-danger" name="request" value="delete">Eliminar Tarea</button>
                        </div>
                    </form>
                </div>
            </div>
