        ...
        <main id="main">
            <div class="page-content project-create project-edit fx-fullCenter">
                <div class="box mg-2 wt-50">
                    ...
                    <form action="<?php echo SERVER_URL . '/projects/update/' . $data['id'] ?>" method="post">
                        <div class="form-content">
                            ...
                            <label>
                                <fieldset class="field-input-container">
                                    <legend>URL: </legend>
                                    <input type="text" name="url" id="" placeholder="URL del proyecto" pattern="[a-zA-Z0-9ñÑ_+-/].{1,}" value="<?php echo $data['url'] ?>">
                                </fieldset>
                            </label>
                            <label>
                                <fieldset class="field-input-container">
                            ...
                            <label for="category">
                                <fieldset class="field-input-container">
                                    ...
                                    <select name="category" id="category">
                                        <option value="1" <?php echo ($data['category'] == 1) ? 'selected' : '' ?> >Proyecto Personal</option>
                                        <option value="2" <?php echo ($data['category'] == 2) ? 'selected' : '' ?> >Proyecto Universidad</option>
                                    </select>
                                </fieldset>
                            </label>
                        </div>
                        <div class="buttons-container">
                            ...
                            <button type="submit" formaction="<?php echo "/corvus/projects/delete/{$data['id']}" ?>" class="btn btn-danger" name="request" value="delete">Eliminar proyecto</button>
                        </div>
                    </form>
                </div>
            </div>
